...
import { Search, Filter, Calendar, Tag, DollarSign, CreditCard, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl border border-slate-700">
      ...
      >
        ...
        <div
          onClick={(e) => {
            e.stopPropagation(); // Prevent the collapse toggle when clearing
            onClearFilters();
          }}
      ...
      {/* 3. This section will now open and close smoothly */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
